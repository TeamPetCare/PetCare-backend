    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/schedules").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.PUT, "/api/schedules/review/*").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.PUT, "/api/schedules/status/*").hasRole("CUSTOMER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/payments/pix/{userId}").permitAll()
